 ...
 *
 * @param {Buffer} templateData PNG data of the first image packed into a NodeJS buffer
 * @param {Buffer} referenceData PNG data of the second image packed into a NodeJS buffer
 *
...
export { cropBase64Image, base64ToImage, imageToBase64, cropImage,
         getMatchesCount, getSimilarityScore };
