...
class ZipExtractor {
  ...
  extractFileName (entry) {
    return this.opts.fileNamesEncoding ? entry.fileName.toString(this.opts.fileNamesEncoding) : entry.fileName;
  }
  ...
  async extractEntry (entry) {
    ...
    if (_.isFunction(onEntry)) {
      onEntry(entry, this.zipfile);
    }
