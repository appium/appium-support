 ...
 * ==, !=, >, <, <=, >=, =
 * @returns {?boolean} null if any of the given versions is not valid. Otherwise true or false
 * depending on the actual comparison result
 * @throws {Error} if an unsupported operator is supplied
 */
...
export {
  ...
  isSameDestination, compareVersions,
};
